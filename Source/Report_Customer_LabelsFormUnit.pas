...
unit Report_Customer_LabelsFormUnit;
...
type
  TReport_Customer_Labels = class(TAvoBase_ReportBase)
  private
      fReportQuery : tQuery;
      fOrgID : string;
...
constructor TReport_Customer_Labels.create(Owner: tComponent );
begin
...
destructor TReport_Customer_Labels.destroy;
begin
...
procedure TReport_Customer_Labels.SetOptions( inOrgID, inStartCycleID, inEndCycleID : string );
var
...
function TReport_Customer_Labels.CanPrint: string;
begin
   result := ferrResult;
end;
