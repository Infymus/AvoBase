...
unit Report_Accounting_DepositSlipByCycleFormUnit;
...
type
  TReport_Accounting_DepositSlipByCycle = class(TAvoBase_ReportBase)
  private
      fReportQuery : tQuery;
      fOrgID : string;
...
constructor TReport_Accounting_DepositSlipByCycle.create(Owner: tComponent );
begin
...
destructor TReport_Accounting_DepositSlipByCycle.destroy;
begin
...
procedure TReport_Accounting_DepositSlipByCycle.SetOptions( inOrgID, inStartCycleID, inEndCycleID : string );
var
...
function TReport_Accounting_DepositSlipByCycle.CanPrint: string;
begin
   result := ferrResult;
end;
