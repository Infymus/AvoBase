...
unit MasterData_ReportAccountingFeesCollectedByCycleUnit;
...
type
   tMasterDataReportAccountingFeesCollectedByCycle = class(tQuery)
   private
      InvoiceObj : tInvoice;
...
constructor tMasterDataReportAccountingFeesCollectedByCycle.Create( inMasterData : tMasterData; inOrgID : string;
...
destructor tMasterDataReportAccountingFeesCollectedByCycle.destroy;
begin
...
procedure tMasterDataReportAccountingFeesCollectedByCycle.HandleCalculated(DataSet: TDataSet);
begin
