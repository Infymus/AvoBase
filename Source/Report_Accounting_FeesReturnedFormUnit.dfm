inherited Report_Accounting_FeesReturned: TReport_Accounting_FeesReturned
  Caption = 'Report_Accounting_FeesReturned'
  PixelsPerInch = 96
  TextHeight = 13
  inherited QReport: TQuickRep
    ...
    inherited Band_Header: TQRBand
      ...
      inherited ReportNameLabel: TQRLabel
        ...
        Caption = 'Report_Accounting_FeesReturnedFormUnit'
        FontSize = 16
        ExplicitWidth = 443
      end
