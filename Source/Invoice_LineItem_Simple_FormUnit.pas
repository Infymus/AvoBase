...
unit	Invoice_LineItem_Simple_FormUnit;
...
type
   tInvoice_LineItem_SimpleForm = class(tForm, iInvoiceLineItem)
      BACK_PANEL: TPanel;
...
constructor tInvoice_LineItem_SimpleForm.create(inOwner: tComponent);
begin
...
procedure tInvoice_LineItem_SimpleForm.FormShow(Sender: TObject);
begin
...
procedure tInvoice_LineItem_SimpleForm.fSetAmountRetail(inValue: currency);
begin
   fCostRetail := inValue;
	retailCostEdit.Text := FormatFloat('####0.00', fCostRetail);
end;

procedure tInvoice_LineItem_SimpleForm.fSetAmountSellAt(inValue: currency);
begin
   fCostSellAt := inValue;
...
procedure tInvoice_LineItem_SimpleForm.fSetAmountYCost(inValue: currency);
begin
   fCostYCost := inValue;
	YcostEdit.Text := FormatFloat('####0.00', fCostYCost);
end;

procedure tInvoice_LineItem_SimpleForm.fSetBackOrderedType(inValue: integer);
begin
   fBackOrderedType := inValue;
   backOrderCombo.ItemIndex := fBackOrderedType;
end;

procedure tInvoice_LineItem_SimpleForm.fSetCycleID(inValue: string);
var
   cycleRec : tCycleRec;
   cnt : integer;
begin
...
procedure tInvoice_LineItem_SimpleForm.fSetID(inValue: string);
begin
   fID := inValue;
end;

procedure tInvoice_LineItem_SimpleForm.fSetLineItemCharge(inValue: boolean);
begin
   fLineItemCharge := inValue;
   lineItemFreeCheckBox.Checked := fLineItemCharge;
end;

procedure tInvoice_LineItem_SimpleForm.fSetOrgControlID(inID: string);
begin
   // Do nothing? Why Hoenie?
end;

procedure tInvoice_LineItem_SimpleForm.fSetOrgID(inValue: string);
var
   cnt : integer;
   orgName : string;
begin
...
procedure tInvoice_LineItem_SimpleForm.fSetProductName(inValue: string);
begin
   fProductName := inValue;
	productNameEdit.Text := fProductName;
end;

procedure tInvoice_LineItem_SimpleForm.fSetQTYOnHand(inValue: integer);
begin
   fQTYOnHand := inValue;
   if (inValue >= 1) then
...
procedure tInvoice_LineItem_SimpleForm.fSetTaxRate(inValue: currency);
begin
   fTaxRate := inValue;
   TaxRateLabel.Caption := CurrToStr( fTaxRate ) + '%';
end;

procedure tInvoice_LineItem_SimpleForm.fSetLineNumber(inValue: integer);
begin
   fLineNumber := inValue;
	OrderProductNumPanel.Caption := intToStr( fLineNumber + 1 );
end;

procedure tInvoice_LineItem_SimpleForm.fSetOrderID(inValue: string);
begin
   fOrderID := inValue;
end;

procedure tInvoice_LineItem_SimpleForm.fSetOrderType(inValue: tOrderTypes);
begin
   fOrderType := inValue;
end;

procedure tInvoice_LineItem_SimpleForm.fSetProductDesc(inValue: string);
begin
   fProductDesc := inValue;
   descriptionEdit.Text := fProductDesc;
end;

procedure tInvoice_LineItem_SimpleForm.fSetProductNum(inValue: string);
begin
   fProductNum := inValue;
	productNumberEdit.Text := fProductNum;
end;

procedure tInvoice_LineItem_SimpleForm.fSetProductPRODN1(inValue: string);
begin
   fprodn1 := invalue;
   db_prodn1.Text := fprodn1;
end;

procedure tInvoice_LineItem_SimpleForm.fSetProductPRODN2(inValue: string);
begin
   fprodn2 := invalue;
   db_prodn2.Text := fprodn2;
end;

procedure tInvoice_LineItem_SimpleForm.fSetProductPRODN3(inValue: string);
begin
   fprodn3 := invalue;
   db_prodn3.Text := fprodn3;
end;

procedure tInvoice_LineItem_SimpleForm.fSetProductPRODN4(inValue: string);
begin
   fprodn4 := invalue;
   db_prodn4.Text := fprodn4;
end;

procedure tInvoice_LineItem_SimpleForm.fSetProductSold(inValue: boolean);
begin
   fProductSold := inValue;
end;

procedure tInvoice_LineItem_SimpleForm.fSetQTYReturned(inValue: integer);
begin
   fQTYReturned := inValue;
end;

procedure tInvoice_LineItem_SimpleForm.fsetQTYSold(inValue: integer);
begin
   fQTYSold := inValue;
   qtySoldEdit.Text := IntToStr( inValue );
end;

procedure tInvoice_LineItem_SimpleForm.fSetQTYFree(inValue: integer);
begin
   fQTYFree := inValue;
   qtyFreeEdit.Text := IntToStr( fQTYFree );
end;

procedure tInvoice_LineItem_SimpleForm.fSetmTaxID(inValue: string);
begin
   fmTaxID := inValue;
   //
...
function tInvoice_LineItem_SimpleForm.fGetAmountRetail: currency;
begin
   fCostRetail := Return_MaskEdit_Curr(retailCostEdit.Text);
   result := fCostRetail;
end;

function tInvoice_LineItem_SimpleForm.fGetAmountSellAt: currency;
begin
   fCostSellAt := Return_MaskEdit_Curr(sellAtCostEdit.Text);
   result := fCostSellAt;
end;

function tInvoice_LineItem_SimpleForm.fGetAmountYcost: currency;
begin
   fCostYCost := Return_MaskEdit_Curr(YcostEdit.Text);
   result := fCostYCost;
end;

function tInvoice_LineItem_SimpleForm.fGetBackOrderedType: integer;
begin
   fBackOrderedType := backOrderCombo.ItemIndex;
   result := fBackOrderedType;
end;

function tInvoice_LineItem_SimpleForm.fGetCycleID: string;
var
   C_ID : string;
   cycleRec : tCycleRec;
begin
...
function tInvoice_LineItem_SimpleForm.fGetID: string;
begin
   result := fID;
end;

function tInvoice_LineItem_SimpleForm.fGetLineItemCharge: boolean;
begin
   fLineItemCharge := lineItemFreeCheckBox.Checked;
   result := fLineItemCharge;
end;

function tInvoice_LineItem_SimpleForm.fGetOrgID: string;
begin
   result := Org_GetOrgIDByOrgName( orgCombo.Text );
end;

function tInvoice_LineItem_SimpleForm.fGetProductName: string;
begin
	fProductName := productNameEdit.Text;
   result := fProductName;
end;

function tInvoice_LineItem_SimpleForm.fGetQTYOnHand: integer;
begin
   result := fQTYOnHand;
end;

function tInvoice_LineItem_SimpleForm.fGetTaxRate: currency;
begin
   result := fTaxRate;
end;

function tInvoice_LineItem_SimpleForm.fGetLineNumber: integer;
begin
   result := fLineNumber;
end;

function tInvoice_LineItem_SimpleForm.fGetOrderID: string;
begin
   result := fOrderID;
end;

function tInvoice_LineItem_SimpleForm.fGetProductDesc: string;
begin
   fProductDesc := descriptionEdit.Text;
   result := fProductDesc;
end;

function tInvoice_LineItem_SimpleForm.fGetProductNum: string;
begin
	fProductNum := productNumberEdit.Text;
   result := fProductNum;
end;

function tInvoice_LineItem_SimpleForm.fGetProductPRODN1: string;
begin
   fprodn1 := db_prodn1.Text;
   result := fProdn1;
end;

function tInvoice_LineItem_SimpleForm.fGetProductPRODN2: string;
begin
   fprodn2 := db_prodn2.Text;
   result := fProdn2;
end;

function tInvoice_LineItem_SimpleForm.fGetProductPRODN3: string;
begin
   fprodn3 := db_prodn3.Text;
   result := fProdn3;
end;

function tInvoice_LineItem_SimpleForm.fGetProductPRODN4: string;
begin
   fprodn4 := db_prodn4.Text;
   result := fProdn4;
end;

function tInvoice_LineItem_SimpleForm.fGetProductSold: boolean;
begin
   result := fProductSold;
end;

function tInvoice_LineItem_SimpleForm.fGetQTYReturned: integer;
begin
   result := fQTYReturned;
end;

function tInvoice_LineItem_SimpleForm.fGetQTYSold: integer;
begin
   fQTYSold := Return_MaskEdit_Int(qtySoldEdit.Text);
   result := fQTYSold;
end;

function tInvoice_LineItem_SimpleForm.fGetQTYFree: integer;
begin
   fQTYFree := Return_MaskEdit_Int(qtyFreeEdit.Text);
   result := fQTYFree;
end;

function tInvoice_LineItem_SimpleForm.fGetmTaxID: string;
begin
...
procedure tInvoice_LineItem_SimpleForm.backOrderComboChange( Sender: TObject);
begin
...
procedure tInvoice_LineItem_SimpleForm.productNumberEditChange( Sender: TObject);
begin
   fLineNew := true;
end;

procedure tInvoice_LineItem_SimpleForm.productNumberEditExit( Sender: TObject);
begin
...
procedure tInvoice_LineItem_SimpleForm.InvoiceLineItemChanged(Sender: TObject);
begin
   RecalculateInvoice;
end;

procedure tInvoice_LineItem_SimpleForm.orgComboChange(Sender: TObject);
begin
   // Years MUST be first
   Cycle_ComboBox_FillCycleYearsExist( Org_GetOrgIDByOrgName(orgCombo.Text), CycleYearComboBox );
   // Numbers MUST be after YEARS
...
procedure tInvoice_LineItem_SimpleForm.CycleYearComboBoxChange(Sender: TObject);
begin
   Cycle_ComboBox_FillCycleNumbersExist( Org_GetOrgIDByOrgName(orgCombo.Text), StrToInt(CycleYearComboBox.Text), CycleNumComboBox );
end;

procedure tInvoice_LineItem_SimpleForm.db_taxclassChange(Sender: TObject);
begin
   // Do nothing right now.
   RecalculateInvoice;
end;

procedure tInvoice_LineItem_SimpleForm.db_taxclassKeyDown(Sender: TObject; var Key: Word; Shift: TShiftState);
begin
   if ( key = VK_TAB ) then
...
procedure tInvoice_LineItem_SimpleForm.sellAtCostEditKeyPress(Sender: TObject;   var Key: Char);
begin
   if ( key = #9 ) then
   begin
...
procedure tInvoice_LineItem_SimpleForm.lineItemFreeCheckBoxClick(Sender: TObject);
begin
   RecalculateInvoice();
   LineItemClicked();
end;

procedure tInvoice_LineItem_SimpleForm.tInvoiceLineItemWaveTaClick(Sender: TObject);
begin
   RecalculateInvoice;
   LineItemClicked();
end;

procedure tInvoice_LineItem_SimpleForm.InvoiceLineItemClicked(Sender: TObject);
begin
...
procedure tInvoice_LineItem_SimpleForm.LineItemClicked;
begin
   if assigned(fInvoiceLineItemClickedEvent) then
      fInvoiceLineItemClickedEvent(Self, fLineNumber);
end;

procedure tInvoice_LineItem_SimpleForm.saleBtnClick(Sender: TObject);
var
  CurPos : tPoint;
begin
   LineItemClicked();
...
procedure tInvoice_LineItem_SimpleForm.DeleteThisItem1Click(Sender: TObject);
begin
   if Assigned( eLineDelete ) then
      eLineDelete( fLineNumber );
end;

procedure tInvoice_LineItem_SimpleForm.DiscountLineItemPrice1Click( Sender: TObject);
var
...
procedure tInvoice_LineItem_SimpleForm.AddProductToInvoice1Click( Sender: TObject);
var
...
procedure tInvoice_LineItem_SimpleForm.TurnOffBackPanel;
begin
   self.BACK_PANEL.BorderWidth := 0;
end;

// RECALCULATE LINE ITEM - This tells the Line_Item_Control to recalculate
procedure tInvoice_LineItem_SimpleForm.RecalculateInvoice;
begin
   { this fTabSaveSellAtAmount is a goddamn HACK. we have to save the amount into a temp
     string field, and then later in the recaculation, put it back. otherwise, delphi on the tab
     event handled somehow internally will WIPE the field out and that sucks ass }
...
procedure tInvoice_LineItem_SimpleForm.Fill_Cycle_Numbers;
var
   cnt : integer;
   cNum : integer;
   cycleRec : tCycleRec;
...
procedure tInvoice_LineItem_SimpleForm.Fill_Cycle_Years;
var
   cnt : integer;
   cYear : integer;
   cycleRec : tCycleRec;
...
procedure tInvoice_LineItem_SimpleForm.SetOrgProductLabels;
begin
