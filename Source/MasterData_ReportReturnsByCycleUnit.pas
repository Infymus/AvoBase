...
unit MasterData_ReportReturnsByCycleUnit;
...
type
   tMasterDataReportReturnList = class(tQuery)
   PRIVATE
      fShowOpen : boolean;
      fShowClosed : boolean;
      fShowCancel : boolean;
...
constructor tMasterDataReportReturnList.Create( inMasterData : tMasterData; inOrgID : string;
   inStartYear, inEndYear, InStartNum, InEndNum : integer;
...
destructor tMasterDataReportReturnList.destroy;
begin
   inherited;
end;
