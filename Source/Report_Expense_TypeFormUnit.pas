...
unit Report_Expense_TypeFormUnit;
...
type
   tReport_Expense_Type = class(TAvoBase_ReportBase)
      QRLabel1: TQRLabel;
      QRLabel4: TQRLabel;
      QRLabel5: TQRLabel;
   ...
   private
      fReportQuery : tMasterDataExpenseTypeList;
      fOrgID : string;
      ferrResult : string;
   public
...
constructor TReport_Expense_Type.create(Owner: tComponent );
begin
...
destructor TReport_Expense_Type.destroy;
begin
...
procedure TReport_Expense_Type.SetOptions( inOrgID : string );
begin
   //
   fOrgID := inOrgID;
   //
   ...
   fReportQuery := tMasterDataExpenseTypeList.Create( masterData );
...
function TReport_Expense_Type.CanPrint: string;
begin
   result := ferrResult;
end;
...
procedure TReport_Expense_Type.Band_DetailBeforePrint( Sender: TQRCustomBand; var PrintBand: Boolean);
begin
  inherited;
   //
