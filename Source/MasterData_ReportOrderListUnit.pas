...
unit MasterData_ReportOrderListUnit;
...
type
   tMasterDataReportOrderList = class(tQuery)
   private
...
constructor tMasterDataReportOrderList.Create( inMasterData : tMasterData; inStartYear, inEndYear, InStartNum, InEndNum : integer );
var
...
destructor tMasterDataReportOrderList.destroy;
begin
   inherited;
end;
...
procedure tMasterDataReportOrderList.HandleCalculated(DataSet: TDataSet);
begin
	// We have none yere.
end;
...
procedure tMasterDataReportOrderList.Update();
begin
	self.Close();
   Self.Open();
end;
