object Invoice_LineItem_Quick_Form: TInvoice_LineItem_Quick_Form
  Left = 696
  Top = 18
  BorderStyle = bsNone
  Caption = 'Invoice_LineItem_Quick_Form'
  ClientHeight = 63
  ClientWidth = 809
  Color = clBtnFace
  ...
  object BACK_PANEL: TPanel
    ...
    object InvoceLineBackPanel: TPanel
      ...
      object LineItemOnePanel: TPanel
        ...
        object db_org: TLabel
          Left = 64
          Top = 44
          Width = 153
          Height = 13
          Caption = 'SalesOrganizationLabel'
          Font.Charset = DEFAULT_CHARSET
          Font.Color = clBlack
          Font.Height = -11
          Font.Name = 'Verdana'
  ...
  object PopMenu: TPopupMenu
    ...
    Left = 320
    Top = 5
    object LineItemOptions1: TMenuItem
      Caption = 'Org, Cycle, BackOrder, Tax Rate, Product Line Desc'
      ImageIndex = 38
      OnClick = LineItemOptions1Click
    end
    object N4: TMenuItem
      Caption = '-'
    end
